...
export const useUserStore = defineStore("user", () => {
    ...
    const getInfo = async () => {
        ...
        roles.value = data.userRole ? [data.userRole] : routeSettings.defaultRoles;
    }
    /** 模拟角色变化 */
    ...
    return {token, roles, username, userAvatar, userProfile, id, login, getInfo, changeRoles, logout, resetToken}
})
