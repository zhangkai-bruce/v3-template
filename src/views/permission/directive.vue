...
import SwitchRoles from "./components/SwitchRoles.vue"</script>
...
<template>
  <div class="app-container">
    ...
    <div class="margin-top-30">
      <div>
        <el-tag v-permission="['admin']" effect="plain" size="large" type="success">
          这里采用了 v-permission="['admin']" 所以只有 admin 可以看见这句话
        </el-tag>
      </div>
      <div>
        <el-tag v-permission="['editor']" effect="plain" size="large" type="success">
          这里采用了 v-permission="['editor']" 所以只有 editor 可以看见这句话
        </el-tag>
      </div>
      <div class="margin-top-15">
        <el-tag v-permission="['admin', 'editor']" effect="plain" size="large" type="success">
    ...
    <div class="margin-top-30">
      ...
      <el-tabs class="margin-top-15" type="border-card">
